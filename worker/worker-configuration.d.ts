/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7887050d00b32242e21449fffebbeb07)
// Runtime types generated with workerd@1.20251011.0 2025-10-14 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Conversation";
	}
	interface Env {
		LINK_CACHE: KVNamespace;
		REALTIMEKIT_ORG_ID: string;
		REALTIMEKIT_API_KEY: string;
		CONVERSATION: DurableObjectNamespace /* Conversation from messageai-worker */;
